...
const appTokenDB = {
    mos_sso_client_products: "l1Q7zkOL59cRqWBkQ12ZiGVW2DBL",
    sso_consumer: "l1Q7zkOL59cRqWBkQ12ZiGVW2DBL",
    simple_sso_consumer: "1g0jJwGmRQhJwvwNOrY4i90kD0m"
};

const allowedOrigins = {
    "http://mos_consumer.ankuranand.in:3020": true,
    "http://consumertwo.ankuranand.in:3030": true,
    'http://mos-sso.client-products.com:4201': true,
...
const originAppName = {
    "http://mos-sso.client-products.com:4201": "mos_sso_client_products",
    "http://mos_consumer.ankuranand.in:3020": "sso_consumer",
...
const userDB = {
    "mo@sso.com": {
        ...
        appPolicy: {
            mos_sso_client_products: { role: "admin", shareEmail: true },
...
const login = (req, res, next) => {
    ...
    if (serviceURL != null) {
        ...
        if (allowedOrigins[url.origin] !== true) {
            return res
                .status(400)
                .json({ message: "Your are not allowed to access the sso-server (bad origin)" });
        }
    }
